...
![enter image description here](https://lh3.googleusercontent.com/Eqhl5FbzwrgTl4FgOdWXJa6mukICJ-UiVeczaDTKpZvbiPwEQK-Zh8jAN5FGf5e28vmjTbpq4x0)
*Collada file*
...
![enter image description here](https://lh3.googleusercontent.com/VHVtcisVLJhVAYuh5Md1_5jCmjcPxoAXTuYQd2S-Q5QKC-cAp89xhnA8cWMmj5slO1uj4yLJHhI)
*Convert the Collada file to a SceneKit file*
...
![enter image description here](https://lh3.googleusercontent.com/HQfJTt1Y1magF1xJxtUrEuHKWZL8vifCbHWby6rHg_2BdzR9NnPlCBCMyM1PQITJIbySQV5DUJw)
*The base node is added to the scene*
...
![enter image description here](https://lh3.googleusercontent.com/VhXKTZ2kmsmy0_7xq0iAkylfD7rxCZMtswkw3XVqNX7SxNBHgNI6HXh3Vm1joP2qMykNzX9BowY)
*The coordinate of the base node*

![enter image description here](https://lh3.googleusercontent.com/JT85DQ8qf7UgfrvsyFyrn_Cj89jy4RMHnGYJweWFCJZZbuvGJSmncvXhnp-frlN4aJXK_v2dutQ)
...
![enter image description here](https://lh3.googleusercontent.com/IP6iHTKlhMsk57spyEpGX6YCX397yIIwZAltJR_atD4MFQXBnnQcuNq5Ggx-312NHRJZcLcfP00)
*The application is performing plane detection with "Seat" detected*
...
// Add the mesh node and extent node as the child nodes so they appear in the scene
...
![enter image description here](https://lh3.googleusercontent.com/FVoxDteJBXHkgFyp-eDTfRpa6daiAtDTnjxw53wYzEMjqZ1okLnHeuHKqsMXgF8ls82Y_jEkHuM)
*Search Furniture by Keyword*

![enter image description here](https://lh3.googleusercontent.com/AeGlI1bjqimEJoiRSGbmNieTl-dNZKNYX0b2x6DGJpvcDkwvhtlZoXF0Uc3NK6Rd7jSJ-_Q4Img)
*Search Furniture by Measurement*

![enter image description here](https://lh3.googleusercontent.com/H_9yLKpOhobY0rmWXqs-fEn-p6BOoBKk1gguWhrf_Y1qG3yNYwqcDXSEYjJJ1qdb4kE8JfXOfw8)
...
filteredRealmResults = realm.objects(Furniture.self).filter("name CONTAINS[c] '\(searchController.searchBar.text!)'")
```
...
![enter image description here](https://lh3.googleusercontent.com/dzhwI5qQQUeyQL_RLlvJl2a28ye2zmQ_UT5NfQ7BnWbvBf-2hhhWa8XtdCAV1KYP8g0sk4Bw4lI)
*The measuring path and the distance result*
...
gridPlane = SCNPlane(width: CGFloat(anchor.extent.x), height: CGFloat(anchor.extent.z))
...
gridNode.physicsBody = SCNPhysicsBody(type: .static, shape: SCNPhysicsShape(geometry: gridPlane, options: nil))

gridNode.physicsBody?.categoryBitMask = 2

gridNode.position = SCNVector3Make(anchor.center.x, 0, anchor.center.z);

gridNode.transform = SCNMatrix4MakeRotation(Float(-Double.pi / 2.0), 1.0, 0.0, 0.0);
...
![enter image description here](https://lh3.googleusercontent.com/AXGpMWgH4Yn02w_LhxXyXDWWNGPt-5lxs-DHoim0ONr9-A461gM7T3hO5Tw4YO4PTCfGfmaTlCM)
*The home page of measuring*
...
![enter image description here](https://lh3.googleusercontent.com/F00RIQVEWooVwUD6j9-i-FH9W10scFRUvJRyKmhZM8wlrSR94JjBL5q_pfTcnEJfjZByAqJLmac)
*The "Search" button is located at the top right corner*
...
![enter image description here](https://lh3.googleusercontent.com/BtWOle5OxeZ6vQf5GPzj5pbmSkOtUT4Q1AlCRoxxb1DfDLQQfSF5Zgy5iCeR4ROeZqXkwDOQjSg)
*A pillow is placed on the bed*
...
![enter image description here](https://lh3.googleusercontent.com/x99zmkvgNiB0e8VjVTz6E9SvhZFhq0T-m9zpefIsNitppGzVrqUieDIrTvsYcA-7qhF43chlqh4)
*The detail page of the bed cabinet*
...
![enter image description here](https://lh3.googleusercontent.com/Vvzzgk8lyxMwu4zQr9k9Oee-e-OSAI6v7IrSE2yBE6Wa89ykOm7g2lF0_a1pw0J85NUXXlQSSWU)
*The nuts of the bed cabinet are made of streaked metal which is shiny, so they reflects the environment map*

![enter image description here](https://lh3.googleusercontent.com/_1rr8QjDc02hp8924OzWqf-XFTZ9l1U-M6iXTAt1Ki5v4P1VtwbMS6wR6Dd5vzGA7EMeWO-VbsY)
*Without environment map, the nuts become black in color and they look faked*
...
![enter image description here](https://lh3.googleusercontent.com/tFvE4N7dFovaxbDoysFiwFNcm-s6htyjULQiSmyEq5N40LCsfB0GeHx6U8kJtArmWe-yF5LouME)
*Using this image to create a lighting environment*
...
![enter image description here](https://lh3.googleusercontent.com/r94ExP6iJRoLwHraoUen4xhBoOju6uSnlDKlk9xPsbJsPulv6kBrkVxqWxKQ_bkK_sHFJLLJC80)
*Common light types in SceneKit*
...
![enter image description here](https://lh3.googleusercontent.com/hbG-RLr20e9KZ9pPT_7I3veMS0UHjbUwRpyzN0_9Y-c3ByovKdpGB5fhxHktODZLBgPI5XYHRK4)
*With spot light: the bed cabinet is less natural and its surface has higher contrast*

![enter image description here](https://lh3.googleusercontent.com/PZYIFg-vQTt6J8zUIDh0eihWqZvEfSWB5Z6AiuqXLnUkY62mh-sVbz_n-t1I0xjBOVN79OpPNmY)
*With spot light: the bed cabinet's surface becomes even darker with dimmer ambient lighting in the real environment*
...
![enter image description here](https://lh3.googleusercontent.com/gzcNFZh043JedsPN9O0LTAR8x23zD_1n6GRvMcftBToHEJhhwDViLzI_w-jkZ1Ulxfn2itBlnwU)
*With directional lighting*

![enter image description here](https://lh3.googleusercontent.com/wpJCbIEMQPH-5ilRrfHG44eqBDo_1Z-uP5s9luVuUcFawg4UblqTVOy6jAlZaRn7oF6TQG0Ls0E)
...
![enter image description here](https://lh3.googleusercontent.com/UxWKGu0hGCYPM4Hq1vouFDtVljot6xbK99yukkKRa7jJw6r0n5GtyLurTzAYYLGyQT1_sqFDT9k)
*Blender software*
...
![enter image description here](https://lh3.googleusercontent.com/nR7OHcP7ZbBUdcA2cj4vgOOZxfE6HRZNnnABk60f09M8njn6e7RHepoQG70KWaZX3Qq7QS7mr0U)
*Rendering shadow*
...
![enter image description here](https://lh3.googleusercontent.com/7Yu9jsBPZPrR0-gdSK70KEQs-oukuzpLPJl3oVtKs5HNV8gOCORTWCOle4dmQLtNtVCThOS2zAg)
*The shadow baked by Blender*
...
![enter image description here](https://lh3.googleusercontent.com/2jlmDsSogAmixD4Lwos8NFax84UKo2_l1sIxywdxz_1lj2CxkyfTThrAaoVK8MW9zj3kNfLSj8c)
*Adding a shadow below the tea table*

Result:

![enter image description here](https://lh3.googleusercontent.com/NhyPNIwTvGgk7lr8AfFW3Uiw5PbGRE0czMIIFm02vBMAazNytsY0wfxpf7nDc3OIXEmCeq-L7P4)
*With shadow below*

![enter image description here](https://lh3.googleusercontent.com/EjpuHlceVJ3Wm9zqZfslpJipuEYYyLYZjPrzAXDx_QLoPG1V6CaunGeK_vkqdC64BD_16H4wQrM)
*Without shadow below*
...
![enter image description here](https://lh3.googleusercontent.com/vJs_Ltqm_3R5jz6B3iAeeWdNA2aDUPH9Xgdtck-ocoNQyhS9gNGf1zdt3jCnsMVJGGX9Ghys7yg)
*A diffuse map of bamboo wood*

- Roughness
It describes how rough the material will be. The rougher the material, the dimmer the reflection, vice versa.

![enter image description here](https://lh3.googleusercontent.com/4eRq9vmDQjMiUtP4j-tt8lXR3nxE5fii5a0EwS8T4PUnhUV910M9bsjqPZET8AzIwcm944hWxjI)
*A roughness map of bamboo wood*
...
![enter image description here](https://lh3.googleusercontent.com/Oxy0xRFlCX3LDzmdynZuvtddG5n2DlU6eKJ4EXblb4dZRAWc3Da9AoVUREMvugS-gcj52d9XRF0)
*The nuts of the bed cabinet are using streaked metal as the material*
...
![enter image description here](https://lh3.googleusercontent.com/ZPOeuYVoNFO5PGQmwij8klkDcduk3CefYBeHueh6mfk_ez-ujOAG1p0NTBUOdk0teuPlHagAiAo)
*Adding protrusion by a normal map to the diffuse content*

![enter image description here](https://lh3.googleusercontent.com/U1-vqoaNnTiziRoXnIecZdGlkHi1C5yGAVuCD9weSXNSiGO4O18_kQqFCgf7EbPeBzjNqKGHFoE)
*A normal map of bamboo wood with some protrusion on it*
...
![enter image description here](https://lh3.googleusercontent.com/nh21s6GS1TrKGEvH_VR6hIMUXT4xqCzlZXSVnIlzB5wjG1o_MFsz39hZ1AtOyEApvo9_Fz9FE-Y)
*The material inspector of the bed cabinet is mainly using the PBR model of bamboo wood*
